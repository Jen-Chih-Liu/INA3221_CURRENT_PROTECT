...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../I2C/I2C_Control.c" 2
# 10 "../I2C/I2C_Control.c"
# 1 "..\\device.h" 1
# 11 "../I2C/I2C_Control.c" 2
...
# 14 "../I2C/I2C_Control.c" 2
# 1 "C:\\Users\\tester\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\string.h" 1 3
# 51 "C:\\Users\\tester\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\string.h" 3
...
extern uint8_t g_au8SerialNumber[16];
extern uint8_t g_au8LotID[16];
extern uint8_t g_au8MFGDate[16];


const uint8_t CMD_ISP[7]
    = {0x4E, 0X05, 0x4A, 0x4D, 0x50, 0x4C, 0x44
      };

const uint8_t CMD_UPIT[4]
    = {'U', 'P', 'I', 'T'};
...
uint8_t Data_Get_Power_Info[16]
=
{
    0x0F, 0x07, 0x1F, 0x00,
...
void I2C1_IRQHandler(void)
{
    ...
    u32Status = ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)))->STATUS0);

    if (( ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)))->TOCTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ))
    {

        I2C_ClearTimeoutFlag(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)));

        I2C_Close(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)));
        I2C1_Init();
    }
    else
    {
        if (s_I2C1HandlerFn != 0)
            s_I2C1HandlerFn(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)), u32Status);
    }
}
...
void I2C_SlaveTRx(I2C_T *i2c, uint32_t u32Status)
{
    ...
    {
        u8Data = (unsigned char) ((i2c)->DAT);

        if (u16SlvDataLen < 256)
        {
...

    {
        ...
        else if ((u16SlvDataLen == 2)&&(au8SlvRxData[0]==0x0f))
        {
            eeprom_ram[0x0f]=au8SlvRxData[1];
            u8EVEN_INDEX_FLAG=1;

        }


        else if ((u16SlvDataLen == 7) && (memcmp(au8SlvRxData, CMD_ISP, 7) == 0))
        {
        ...
        else if ((u16SlvDataLen == 8) && (memcmp(au8SlvRxData, CMD_UPIT, 4) == 0))
        {
        ...
        else if ((u16SlvDataLen == 8) && (memcmp(au8SlvRxData, CMD_UPCD, 4) == 0))
        {
        ...
        else if ((u16SlvDataLen == 5) && (memcmp(au8SlvRxData, CMD_SWDC, 4) == 0))
        {
        ...
        else if ((u16SlvDataLen == 9) && (memcmp(au8SlvRxData, CMD_UPCA, 4) == 0))
        {
            ...
            if (ch_idx < 6)
            {
                ...
                uint16_t ram_offset = 0x10 + (ch_idx * 4);
        ...
        else if ((u16SlvDataLen == 20) && (memcmp(au8SlvRxData, CMD_UPMF, 4) == 0))
        {
            u8UPMFFlag = 1;
            memcpy(g_au8MFGDate, &au8SlvRxData[4], 16);
            memcpy((void *)&eeprom_ram[0xC0], g_au8MFGDate, 16);
            u8ReportEEPROMFlag = 0;
        }


        else if ((u16SlvDataLen == 20) && (memcmp(au8SlvRxData, CMD_UPLT, 4) == 0))
        {
            u8UPLTFlag = 1;
            memcpy(g_au8LotID, &au8SlvRxData[4], 16);
            memcpy((void *)&eeprom_ram[0xD0], g_au8LotID, 16);
            u8ReportEEPROMFlag = 0;
        }


        else if ((u16SlvDataLen == 20) && (memcmp(au8SlvRxData, CMD_UPSN, 4) == 0))
        {
            u8UPSNFlag = 1;
            memcpy(g_au8SerialNumber, &au8SlvRxData[4], 16);
...
void I2C1_Init(void)
{
    ...
    CLK_EnableModuleClock((((uint32_t)(((1) & 0x03) << 30))|((uint32_t)((((9)) & 0x1f) << 0)) | ((uint32_t)(((0x0) & 0x03) << 28))|((uint32_t)(((0x0) & 0x07) << 25))|((uint32_t)(((0x0) & 0x1f) << 20))| ((uint32_t)(((0x0) & 0x03) << 18))|((uint32_t)(((0x0) & 0xff) << 10))|((uint32_t)(((0x0) & 0x1f) << 5))));





    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPA_MFPL = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPA_MFPL & ~((0xful << (8)) | (0xful << (12)))) | ((0x09UL<<(8)) | (0x09UL<<(12)));

    ((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04000UL))->SMTEN |= (0x1ul << (2)) | (0x1ul << (3));

    I2C_Open(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)), 100000);


    I2C_SetSlaveAddr(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)), 0, 0x4D, 0);


    I2C_EnableInt(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)));
    __NVIC_EnableIRQ(I2C1_IRQn);
    __NVIC_SetPriority(I2C1_IRQn, 1);
    ...
    ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)))->CTL0 & ~0x3c) | (0x0CUL));
}
