...
# 47 "../../../../Library/StdDriver/src/retarget.c"
...
# 72 "../../../../Library/StdDriver/src/retarget.c"
...
{
    (void)stack;
# 101 "../../../../Library/StdDriver/src/retarget.c"
}
# 159 "../../../../Library/StdDriver/src/retarget.c"
...
uint32_t ProcessHardFault(uint32_t lr, uint32_t msp, uint32_t psp)
{
    uint32_t *sp;
    uint32_t inst;
# 194 "../../../../Library/StdDriver/src/retarget.c"
        if (lr & 4UL)
        {
            sp = (uint32_t *)psp;
        }
...
# 217 "../../../../Library/StdDriver/src/retarget.c"
    inst = (*((vu16 *) (sp[6])));
...
# 246 "../../../../Library/StdDriver/src/retarget.c"
void SendChar_ToUART(int ch)
{
...
# 337 "../../../../Library/StdDriver/src/retarget.c"
__attribute__((weak)) void SendChar(int ch)
{
# 370 "../../../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 382 "../../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 433 "../../../../Library/StdDriver/src/retarget.c"
    while (1)
    {
...
# 633 "../../../../Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    (void)stream;
    return ((int)GetChar());
}
# 655 "../../../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    (void)stream;
    return (-1);
