# 1 "../Monitor/Monitor_Control.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 391 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Monitor/Monitor_Control.c" 2
# 10 "../Monitor/Monitor_Control.c"
# 1 "..\\device.h" 1
# 11 "../Monitor/Monitor_Control.c" 2
...
# 12 "../Monitor/Monitor_Control.c" 2
...
void I2C1_Init(void);
# 13 "../Monitor/Monitor_Control.c" 2
...
# 14 "../Monitor/Monitor_Control.c" 2
...
const uint8_t CH_Enalbe_Monitor_0[3] = {0x00000001, 0x00000001, 0x00000001};
volatile uint8_t g_u8TargetCH_0 = 0;
volatile uint8_t g_u8GetEndFlag_0 = 1;
volatile uint8_t g_u8GetErrorFlag_0 = 0;
volatile uint8_t g_u8Status_0 = 0;
volatile uint16_t g_u16TempData_0[2];
Monitor_Data_T au8MonitorData_0[3];
const uint16_t Shunt_Ratio_Molecular_0[3] = {200, 200, 200};
const uint16_t Shunt_Ratio_Denomination_0[3] = {1, 1, 1};

const uint16_t Shunt_Ratio_Molecular_1[3] = {200, 200, 200};
const uint16_t Shunt_Ratio_Denomination_1[3] = {1, 1, 1};

const uint8_t CH_Enalbe_Monitor_1[3] = {0x00000000, 0x00000000, 0x00000000};
volatile uint8_t g_u8TargetCH_1 = 0;
volatile uint8_t g_u8GetEndFlag_1 = 1;
volatile uint8_t g_u8GetErrorFlag_1 = 0;
volatile uint16_t g_u16TempData_1[2];
volatile uint8_t g_u8Status_1 = 0;
Monitor_Data_T au8MonitorData_1[3];
...
void I2C0_IRQHandler(void)
{
    ...
    u32Status = ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)))->STATUS0);

    if (( ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)))->TOCTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ))
    {

        I2C_ClearTimeoutFlag(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)));

        if (g_u8GetEndFlag_0 != 1)
        {
            I2C0_Error_Hanlder(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)));

            I2C_Close(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)));
            I2C0_Init();
        }
    }
    else
    {
        ...
        {
            s_I2C0HandlerFn(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)), u32Status);
        }
    }
}
...
void I2C0_MasterTRx(I2C_T *i2c, uint32_t u32Status)
{
    ...
    else if (u32Status == 0x18)
    {
        if (g_u8Status_0 == 2)
        {
            ((i2c)->DAT = (0x01 + g_u8TargetCH_0 * 2));
        }
        else if (g_u8Status_0 == 7)
        {
            ((i2c)->DAT = (0x01 + g_u8TargetCH_0 * 2 + 1));
        }
    ...
    {
        g_u16TempData_0[0] = (unsigned char) ((i2c)->DAT);
    ...
    {
        g_u16TempData_0[1] = (unsigned char) ((i2c)->DAT);

        if (g_u8Status_0 == 5)
        {
            sign = g_u16TempData_0[0] & (0x00000080UL);
            ...
            uint16_t u16CurrentOffset = 0x30 + (g_u8TargetCH_0 * 4);
        ...
        else if (g_u8Status_0 == 10)
        {
            ...
            data = (data * 8 + 5) / 10;
            uint16_t u16VoltageOffset = 0x30 + (g_u8TargetCH_0 * 4) + 2;
...
void I2C0_Init(void)
{
    ...
    CLK_EnableModuleClock((((uint32_t)(((1) & 0x03) << 30))|((uint32_t)((((8)) & 0x1f) << 0)) | ((uint32_t)(((0x0) & 0x03) << 28))|((uint32_t)(((0x0) & 0x07) << 25))|((uint32_t)(((0x0) & 0x1f) << 20))| ((uint32_t)(((0x0) & 0x03) << 18))|((uint32_t)(((0x0) & 0xff) << 10))|((uint32_t)(((0x0) & 0x1f) << 5))));





    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPC_MFPL = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPC_MFPL & ~((0xful << (0)) | (0xful << (4)))) | ((0x09UL<<(0)) | (0x09UL<<(4)));

    ((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04080UL))->SMTEN |= (0x1ul << (0)) | (0x1ul << (1));

    I2C_Open(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)), 100000);


    uint8_t data[2];
    data[0] = (0x7a47>>8)&0xff;
    data[1] = (0x7a47)&0xff;


    I2C_WriteMultiBytes(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)), 0x40, data, 2);
    unsigned int u32TimeOutCount = SystemCoreClock;

    while ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)))->CTL0 & (0x1ul << (4)))
    {
        u32TimeOutCount--;
    ...
    I2C_EnableInt(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)));
    __NVIC_EnableIRQ(I2C0_IRQn);
    __NVIC_SetPriority(I2C0_IRQn, 2);
...
void USCI1_IRQHandler(void)
{
    ...
    u32Status = (((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL))->PROTSTS);

    if ((((((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)))->PROTSTS & (0x1ul << (5))) == (0x1ul << (5)) ? 1:0))
    {

        UI2C_ClearTimeoutFlag(((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)));

        if (g_u8GetEndFlag_1 != 1)
        {
            UI2C1_Error_Hanlder(((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)));

            UI2C_Close(((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)));
            UI2C1_Init();
        }
    }
    else
    {
        if (s_UI2C1HandlerFn != (0))
        {
            s_UI2C1HandlerFn(((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)), u32Status);
        }
    }
}
...
void UI2C1_MasterTRx(UI2C_T *ui2c, uint32_t u32Status)
{
    ...
    if ((u32Status & (0x1ul << (8))) == (0x1ul << (8)))
    {
        ...
        else if (g_u8Status_1 == 3)
        {
            ((ui2c)->TXDAT = (((0x40 << 1) + 1)));
        }
        else if (g_u8Status_1 == 6)
        {
            ((ui2c)->TXDAT = (((0x40 << 1) )));
        }
        else if (g_u8Status_1 == 8)
        {
            ((ui2c)->TXDAT = (((0x40 << 1) + 1)));
        }

        ((ui2c)->PROTCTL = ((ui2c)->PROTCTL & ~0x2EU) | (0x20UL));
    }
    else if ((u32Status & (0x1ul << (13))) == (0x1ul << (13)))
    {
        ...
        if (g_u8Status_1 == 1)
        {
            ((ui2c)->TXDAT = (0x01 + g_u8TargetCH_1 * 2));

            g_u8Status_1++;

            ((ui2c)->PROTCTL = ((ui2c)->PROTCTL & ~0x2EU) | (0x20UL));
        }
        else if (g_u8Status_1 == 2)
        {
            g_u8Status_1++;

            ((ui2c)->PROTCTL = ((ui2c)->PROTCTL & ~0x2EU) | ((0x20UL | 0x08UL)));
        }
        else if (g_u8Status_1 == 3)
        {
            g_u8Status_1++;

            ((ui2c)->PROTCTL = ((ui2c)->PROTCTL & ~0x2EU) | (0x20UL | 0x02UL));
        }
        else if (g_u8Status_1 == 4)
        {
            g_u16TempData_1[0] = (unsigned char) ((ui2c)->RXDAT);
        ...
        {
            ((ui2c)->TXDAT = (0x01 + g_u8TargetCH_1 * 2 + 1));

            g_u8Status_1++;

            ((ui2c)->PROTCTL = ((ui2c)->PROTCTL & ~0x2EU) | (0x20UL));
        }
        else if (g_u8Status_1 == 7)
        {
            g_u8Status_1++;
    ...
    else if ((u32Status & (0x1ul << (10))) == (0x1ul << (10)))
    {
        ...
        if (g_u8Status_1 == 5)
        {
            g_u16TempData_1[1] = (unsigned char) ((ui2c)->RXDAT);

            sign = g_u16TempData_1[0] & (0x00000080UL);
            ...
            data = ((data * 40 * Shunt_Ratio_Molecular_1[g_u8TargetCH_1]) / (Shunt_Ratio_Denomination_1[g_u8TargetCH_1] * 1000) + 5) / 10;
            uint16_t u16CurrentOffset = 0x30 + ((g_u8TargetCH_1 + 3) * 4);
            eeprom_ram[u16CurrentOffset + 0] = (uint8_t)(data);
            eeprom_ram[u16CurrentOffset + 1] = (uint8_t)(data >> 8);
        ...
        else if (g_u8Status_1 == 10)
        {
            ...
            data = (data * 8 + 5) / 10;
            uint16_t u16VoltageOffset = 0x30 + ((g_u8TargetCH_1 + 3) * 4) + 2;
            eeprom_ram[u16VoltageOffset + 0] = (uint8_t)(data);
            eeprom_ram[u16VoltageOffset + 1] = (uint8_t)(data >> 8);

            g_u8TargetCH_1++;

            while (g_u8TargetCH_1 < 3)
            {
            ...
            if (g_u8TargetCH_1 == 3)
            {
                ...
                ((ui2c)->PROTCTL = ((ui2c)->PROTCTL & ~0x2EU) | ((0x20UL | 0x04UL)));
            }
            else
            {
                g_u8Status_1 = 1;
...
void UI2C1_Init(void)
{
    ...
    CLK_EnableModuleClock((((uint32_t)(((2) & 0x03) << 30))|((uint32_t)((((9)) & 0x1f) << 0))| ((uint32_t)(((0x0) & 0x03) << 28))|((uint32_t)(((0x0) & 0x07) << 25))|((uint32_t)(((0x0) & 0x1f) << 20))| ((uint32_t)(((0x0) & 0x03) << 18))|((uint32_t)(((0x0) & 0xff) << 10))|((uint32_t)(((0x0) & 0x1f) << 5))));





    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPL = (((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->GPB_MFPL & ~((0xful << (8)) | (0xful << (4)))) | ((0x08UL<<(8)) | (0x08UL<<(4)));

    ((GPIO_T *) (((uint32_t)0x40000000UL) + 0x04040UL))->SMTEN |= (0x1ul << (2)) | (0x1ul << (1));

    UI2C_Open(((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)), 100000);
    ...
    UI2C_WriteMultiBytes(((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)), 0x40, data, 2);


    ((((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)))->PROTIEN |= (((0x1ul << (6)) | (0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (1)))));
    __NVIC_EnableIRQ(USCI1_IRQn);
    __NVIC_SetPriority(USCI1_IRQn, 2);
...
void Read_Monitor_Data_0(void)
{
    if (g_u8GetEndFlag_0 == 1)
    {
        ...
        else
        {
            ...
            I2C_EnableTimeout(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)), 1);


            g_u8Status_0 = 1;


            ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)))->CTL0 = ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x40000UL)))->CTL0 & ~0x3c) | (0x20UL));
        }
    }
}
...
void Read_Monitor_Data_1(void)
{
    if (g_u8GetEndFlag_1 == 1)
    {
        ...
        else
        {
            ...
            UI2C_EnableTimeout(((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)), 0x3FF);
            ((((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)))->PROTSTS = ((0x1ul << (5))));
            ((((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)))->PROTIEN |= ((0x1ul << (0))));


            g_u8Status_1 = 1;


            ((((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)))->PROTCTL = ((((UI2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x91000UL)))->PROTCTL & ~0x2EU) | (0x08UL));
        }
    }
}
