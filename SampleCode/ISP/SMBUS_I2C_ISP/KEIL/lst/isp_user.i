...
uint32_t volatile g_apromSize, g_dataFlashAddr, g_dataFlashSize;
...
int ParseCmd(unsigned char *buffer, uint8_t len)
{
    ...
    {
        (*((volatile unsigned int *)(response + 8))=(((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PDID));
        goto out;
    }
    else if (lcmd == 0x000000AB || lcmd == 0x000000AC || lcmd == 0x000000AD)
    {
        ...
        if (lcmd == 0x000000AB)
        {
            i = (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL & 0xFFFFFFFC);
        }
        ...
        {
            i = (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL & 0xFFFFFFFE);
        }

        (*((volatile unsigned int *)(&((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL))=(i));
        __NVIC_SystemReset();
...
# 137 "../isp_user.c"
    ...
    else if (lcmd == 0x000000CA)
    {
        ...
        (*((volatile unsigned int *)(response + 8))=((((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL & 0x2) ? 2 : 1));
    }
