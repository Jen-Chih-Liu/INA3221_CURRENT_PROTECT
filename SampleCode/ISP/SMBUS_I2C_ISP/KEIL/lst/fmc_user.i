...
int FMC_Proc(uint32_t u32Cmd, uint32_t addr_start, uint32_t addr_end, uint32_t *data)
{
    ...
    {
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCMD = u32Cmd;
        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPADDR = u32Addr;

        if (u32Cmd == 0x21UL)
        {
            ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT = *data;
        }

        ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG = 0x1;
        __builtin_arm_isb(0xF);

        while (((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPTRG & 0x1) ;

        uint32_t Reg;

        Reg = ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL;

        if (Reg & (0x1ul << (6)))
        {
            ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL = Reg;
            return -1;
        }

        if (u32Cmd == 0x00UL)
        {
            *data = ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPDAT;
        }
