...
static inline void I2C_SlaveTRx(I2C_T *i2c, uint32_t u32Status);

extern uint32_t Pclk0;


uint8_t au8UpdateData[34];
uint8_t au8SlvRxData[34];
...
const uint8_t CMD_ERASE[7]
    = {0xb0, 0X05, 0x45, 0x52, 0x41, 0x53, 0x45
      };


const uint8_t CMD_JMPAP[7]
...
extern __attribute__((aligned(4))) uint8_t Write_buff[32];
extern __attribute__((aligned(4))) uint8_t Read_buff[32];
void I2C_Init(void)
{
    ...
    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL))->CLKDIV = (uint32_t)(((Pclk0 * 10U) / (100000 * 4U) + 5U) / 10U - 1U); ;
    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL))->CTL0 |= (0x1ul << (6));

    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL))->ADDR0 = (0x4D << 1U) | 0;
    ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL))->CTL0 |= (0x1ul << (7));
...
void I2C1_IRQHandler(void)
{
    ...
    if (( ((((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)))->TOCTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ))
    {
        ...
        ((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL))->TOCTL |= (0x1ul << (0));
    }
    else
    {
        I2C_SlaveTRx(((I2C_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x41000UL)), u32Status);
    }
}
