...
extern volatile uint32_t g_apromSize, g_dataFlashAddr, g_dataFlashSize;
...
__attribute__((aligned(4))) uint8_t Write_buff[32];
__attribute__((aligned(4))) uint8_t Read_buff[32];
...
void SYS_Init(void)
{
    ...
    while (!(((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->STATUS & (0x1ul << (4))));

    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKSEL0 & (~(0x7ul << (0)))) | (0x07UL<<(0));
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 = (((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->CLKDIV0 & (~(0xful << (0)))) | (((1)-1) << (0));


    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->PCLKDIV = (0x1UL<<(0)) | (0x1UL<<(4));
    ...
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->APBCLK0 |= (0x1ul << (9));
...
__attribute__((aligned(4))) static uint8_t aprom_buf[0x200UL];
...
static uint16_t CalCheckSum(uint32_t start, uint32_t len)
{
    ...
    for (i = 0; i < len; i += 0x200UL)
    {
        ReadData(start + i, start + i + 0x200UL, (uint32_t *)aprom_buf);

        if (len - i >= 0x200UL)
            lcksum += Checksum(aprom_buf, 0x200UL);
        else
...
int main(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x40000000UL) + 0x00200UL))->AHBCLK |= (0x1ul << (2)) | (0x1ul << (4));
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL |= ((0x1ul << (0)) | (0x1ul << (3)));
    g_apromSize = 0xd000;
    FMC_Read_User((0xd000 - 4), (uint32_t *)&cksum);
    g_dataFlashAddr = 0xd000;
    g_dataFlashSize = 0;
    I2C_Init();


    if ((((*((volatile unsigned int *)(&((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->RSTSTS)))) & 0x3) == 0x00)
    {
        goto _LDROM_LOOP;
    }


    code_check_flash = CalCheckSum(0x0, (0xd000 - 4));
...
_LDROM_LOOP:
    ...
    while (1)
    {
        ...
        {
            if (EraseAP(0x00000000UL, g_apromSize) == 0)
            {
                StartAddress = 0x00000000UL;
                i2c_ack_data = 0xaa;
            }
            else
            {
        ...
        {
            u8PROGAPflag = 0;
            WriteData(StartAddress, StartAddress + 32, (uint32_t *)Write_buff);
...
_APROM:
    ...
    ((FMC_T *) (((uint32_t)0x40000000UL) + 0x0C000UL))->ISPCTL &= ~((0x1ul << (0)) | (0x1ul << (1)));
    __NVIC_SystemReset();
