# 1 "../startup_m251_isp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 391 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../startup_m251_isp.c" 2
# 10 "../startup_m251_isp.c"
# 1 "C:\\Users\\tester\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\inttypes.h" 1 3
# 19 "C:\\Users\\tester\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\inttypes.h" 3
...
# 20 "C:\\Users\\tester\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\inttypes.h" 2 3
# 213 "C:\\Users\\tester\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\inttypes.h" 3
...
void IRCTRIM_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void PWRWU_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void CLKFAIL_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
void PWM0_P0_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void PWM0_P1_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void PWM0_P2_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void BRAKE1_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void PWM1_P0_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void PWM1_P1_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void PWM1_P2_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
void EADC_INT0_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void EADC_INT1_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
void EADC_INT2_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void EADC_INT3_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
void CRPT_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void SC0_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void USCI2_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void LCD_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void OPA_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
void TK_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
__attribute__((__noreturn__)) void Reset_Handler(void)
{
    ...
    (*((volatile unsigned int *)(((((uint32_t)0x40000000UL) + 0x00000UL) + 0x180)))=((((*((volatile unsigned int *)((((uint32_t)0x40000000UL) + 0x00000UL) + 0x180)))) & ~(0x00000080UL))));

    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PORCTL0 = 0x5AA5;
    ((SYS_T *) (((uint32_t)0x40000000UL) + 0x00000UL))->PORCTL1 = 0x5AA5;
